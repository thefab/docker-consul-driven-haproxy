...
ENV CONDRI_HAPROXY_SYSLOG_IP=127.0.0.1 \
    ...
    CONDRI_HAPROXY_SERVICE_TAGS=tag1,tag2 \
    CONDRI_HAPROXY_LIMIT_TO_ONE_CONTAINER=0 \
    CONDRI_HAPROXY_LIMIT_TO_FULL_FEATURED_CONTAINERS=0 \
    CONDRI_HAPROXY_LIMIT_BY_CONTAINER_NAME="" \
    CONDRI_HAPROXY_LIMIT_BY_CONTAINER_NAME_AT="" \
    CONDRI_HAPROXY_CONSUL=localhost:8085 \
    CONDRI_HAPROXY_IGNORE_EMPTY_CONSUL_RESULTS_MINUTES=0 \
    CONDRI_HAPROXY_PUBLISH_LINKS=0

# FIXME: fix CONDRI_HAPROXY_IGNORE_EMPTY_CONSUL_RESULTS_MINUTES
